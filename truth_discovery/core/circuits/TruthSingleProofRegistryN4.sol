...
contract TruthSingleProofRegistryN4 {
    ...
    function verifySelectedProofFlat(
        ...
        return this.verifySelectedProof(a, b, c, pubSignals);
    }
    ...
    function submitSelectedProofFlat(
        ...
        if (!this.verifySelectedProof(a, b, c, pubSignals)) revert InvalidProof();
