...
ABI_FILE_PATH="${ABI_FILE_PATH:-${CONTRACT_DIR}/TruthSingleProofRegistryN4.abi}"
BIN_FILE_PATH="${BIN_FILE_PATH:-${CONTRACT_DIR}/TruthSingleProofRegistryN4.bin}"
